...
#define CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) ACTOR_FSM_STATE( STRUCT_NAME, S1 );
#define CREATE_STRUCT_IMPL_2(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_1(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_3(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_2(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_4(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_3(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_5(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_4(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_6(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_5(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_7(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_6(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_8(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_7(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_9(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_8(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_10(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_9(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_11(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_10(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_12(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_11(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_13(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_12(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_14(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_13(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_15(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_14(STRUCT_NAME, __VA_ARGS__)
#define CREATE_STRUCT_IMPL_16(STRUCT_NAME, S1, ...) CREATE_STRUCT_IMPL_1(STRUCT_NAME, S1) CREATE_STRUCT_IMPL_15(STRUCT_NAME, __VA_ARGS__)

#define CREATE_STRUCT_IMPL(_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13,_14,_15,_16,NAME,...) NAME

#define CREATE_FSTRUCT_IMPL_1(STRUCT_NAME, S1) ACTOR_FSM_STATE_FUNCTIONS(STRUCT_NAME, S1 );
...
#define CREATE_INIT_IMPL_1(STRUCT_NAME, S1) ACTOR_FSM_STATE_INIT_STRUCT(STRUCT_NAME, S1 );
...
#define ACTOR_CREATE_STATE_MACHINE(N, ...) \
    ...
    static void init##N(N * sm) {          \
        ...
        sm->fsmState = sm->FIRST_ARG_(__VA_ARGS__);                                                                                                                      \
        sm->update = &update##N;\
    }
