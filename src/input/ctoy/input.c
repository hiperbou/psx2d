...
uint16_t getButtons(int player) {
    return (ctoy_key_pressed(CTOY_KEY_LEFT) && !ctoy_key_pressed(CTOY_KEY_RIGHT) ? PAD_LEFT : 0) |
            (ctoy_key_pressed(CTOY_KEY_RIGHT) && !ctoy_key_pressed(CTOY_KEY_LEFT) ? PAD_RIGHT : 0) |
